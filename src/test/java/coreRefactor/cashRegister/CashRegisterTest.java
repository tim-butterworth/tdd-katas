...
public class CashRegisterTest {
    ...
    public void water_costs_100_cents() {
        assertThat(cashRegister.checkout(Collections.singletonList(WATER))).isEqualTo(100);
    }

    @Test
    public void milk_costs_400_cents() {
        assertThat(cashRegister.checkout(Collections.singletonList(MILK))).isEqualTo(400);
    }

    @Test
    public void fancy_water_costs_200_cents_plus_8_percent_tax() {
        assertThat(cashRegister.checkout(Collections.singletonList(FANCY_WATER))).isEqualTo(216);
    }

    @Test
    public void green_beans_cost_50_cents_plus_8_percent_tax() {
        assertThat(cashRegister.checkout(Collections.singletonList(GREEN_BEANS))).isEqualTo(54);
    }
    ...
    public void only_a_fancy_water_coupon_does_not_give_you_money_back() {
        assertThat(cashRegister.checkout(Collections.singletonList(FANCY_WATER_COUPON))).isEqualTo(0);
    }
}